...
| 楓町町屋 | 楓町町屋 | 1.0.0，新版 skill 首件作品（任務書在 work/kaede_machiya/build_plan.md） |
...
- 結構 ID：`machiya_260920:kaede_house`，單一結構，寬 17 × 深 31 × 高 17 格。
- 一鍵放置：`/structure load machiya_260920:kaede_house 100 64 100`；Y 為街道面高度，正面朝 -Z。
- 京町屋：見世、通庭、二樓寢間與書齋、坪庭（池、楓、石燈籠）、離屋茶室；56 種方塊，對照 Mojang v1.26.50。
